                  ...
                  <div>
                    <div>
                      <div className="ItemRow RowHead">
                        <p className="uppercase lablel label--head  size--3 pd-top-8">
                          {data[obj]?.profile.long_name}
                        </p>
                      </div>
                    </div>
                  </div>
                  <div>
                    <div>
                      ...
                      <div className="ItemRow">
                        <p className="capitalize lablel  size--3">
                          {" "}
                          {data[obj]?.profile.address1}
                        </p>
                      </div>
                      {data[obj]?.profile?.address2 && (
                      ...
                      <div className="ItemRow">
                        <p className="lablel  size--3">
                          {" "}
                          {data[obj]?.profile.city}, {data[obj]?.profile.state}{" "}
                          {data[obj]?.profile.zip}
                        </p>
                      </div>
                      <div className="ItemRow">
                        <p className="lablel  size--3">
                          {" "}
                          {data[obj]?.profile.country}
                        </p>
                      </div>
                      <div className="ItemRowGray">
                        <p className="capitalize lablel  size--3">
                          {" "}
                          {data[obj]?.profile.phone}
                        </p>
                      </div>
                      <div className="ItemRow">
                        <p className="lablel  size--3">
                          {" "}
                          <a href={data[obj]?.profile.website}>
                            {data[obj]?.profile.website}{" "}
                          </a>
                        </p>
                      </div>
                    </div>
                    <div>
                      <div className="ItemRow">
                        <p className="lablel  size--3">
                          ...
                          <span className="capitalize">
                            {data[obj]?.profile.sector}
                          </span>{" "}
                        </p>
                      </div>
                      <div className="ItemRowGray">
                        <p className="capitalize lablel  size--3">
                          Industry: {data[obj]?.profile.industry}
                        </p>
                      </div>
                      <div className="ItemRow">
                        <p className="lablel  size--3">
                      ...
                      <div className="ItemRowGray">
                        <p className="capitalize lablel label--head  size--3">
                          &nbsp;
                        </p>
                      </div>
                      <div className="ItemRowGray">
                  ...
                  <div>
                    <div>
                      ...
                      <div className="des-pragrap">
                        <p className=" size--3">
                          {data[obj]?.profile.long_business_summary}
                        </p>
                      </div>
                    </div>
                  </div>
